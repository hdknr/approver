========================================================================
** approver ** Installation Instructions
========================================================================

This section contains information about 
how to download and install **approver** in your system. 
...
To install **approver** from soruce code, use the provided installation script::
...
the `source code repository`_ using ``pip``::
    ...
    pip install -e git+https://github.com/hdknr/approver.git#egg=approver

The above command will install the latest development release of **approver**.
